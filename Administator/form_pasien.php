...
$pasien_id = $_GET ['id'] ??0;
if ($pasien_id){
    $insertPasienSQL ="SELECT * FROM pasien WHERE id =?";
    $pasien =$dbh ->prepare($insertPasienSQL);
    $pasien->execute ([$pasien_id]);
    $tombol ="ubah";
            ...
            <div class="card-body">
                <form method="POST" action="proses_pasien.php">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="gender" id="gender_0" type="radio" class="custom-control-input" checked> 
                    ...
                    <div class="offset-4 col-8">
                        <input type="submit" name="proses" id="proses" clas="btn btn-primary" value="<?= $pasien_id ?'ubah':'simpan'?>">
